...
class AppConfig {
  ...
  static String get dbHost => _env['DATABASE_HOST'] ?? 'localhost';
  static int get dbPort => int.tryParse(_env['DATABASE_PORT'] ?? '5432') ?? 5432;
  static String get dbName => _env['DATABASE_NAME'] ?? 'Erp';
  static String get dbUser => _env['DATABASE_USER'] ?? 'postgres';
  static String get dbPassword => _env['DATABASE_PASSWORD'] ?? 'postgresql123';
